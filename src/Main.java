...
*/
import java.util.*;//implemento tutti gli import di java.util
import java.io.*;//implemento tutti gli import di java.io
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        File fileScelto = FileChooserUtility.scegliFilePerSalvare();//richamo tedodo della classe
        ...
        try (FileWriter writer = new FileWriter(fileScelto)) {
            ...
            System.out.println("Classifica salvata su file:"+ fileScelto.getName());
        } catch (IOException e) {
